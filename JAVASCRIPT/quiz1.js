document.addEventListener("DOMContentLoaded", () => {
  ...
  const quizData_jobs = {
    web: [
      ...
      {
        id: "web_front_interest",
        q: "프론트엔드 쪽에서 더 흥미로운 영역은 무엇인가요?",
        a: [
          "화면 레이아웃과 디자인 구현",
          "사용자 인터랙션과 애니메이션",
          "상태 관리와 데이터 흐름 설계",
      ...
      {
        id: "web_backend_interest",
        q: "백엔드 쪽에서 더 흥미로운 영역은 무엇인가요?",
        a: [
          "REST API 설계와 서버 로직 구현",
          "DB 설계와 데이터 모델링",
          "로그인/권한/보안 처리",
          "대용량 트래픽과 서버 성능 개선"
        ]
      ...
      {
        id: "web_stack_preference",
        q: "웹 개발에서 선호하거나 배우고 싶은 기술 조합은 무엇인가요?",
        a: [
          "React + Node.js",
          "React + Spring Boot",
          "Vue + Spring Boot",
      ...
      {
        id: "web_project_type",
        q: "포트폴리오로 만들고 싶은 웹 프로젝트 유형은 무엇인가요?",
        a: [
          "커뮤니티/SNS 서비스",
          "쇼핑몰/예약/결제 서비스",
          "대시보드/관리자 페이지",
      ...
      {
        id: "web_priority",
        q: "웹 개발자로 성장하기 위해 가장 보완하고 싶은 부분은 무엇인가요?",
        a: [
          "HTML/CSS/JavaScript 기본기",
          "React 같은 프론트 프레임워크",
          "Spring/Node 같은 백엔드 프레임워크",
          "배포, 서버, DB 연결 경험"
        ]
      }
    ],
    ...
    mobile: [
      {
        id: "mobile_platform",
        q: "어떤 모바일 앱 개발 방향에 더 관심이 있나요?",
        a: [
          "Android 앱 개발",
          "iOS 앱 개발",
          "Android/iOS 모두 가능한 크로스플랫폼",
          "아직 정하지 못했어요"
        ]
      },
      {
        id: "mobile_stack",
        q: "배우고 싶거나 관심 있는 모바일 기술은 무엇인가요?",
        a: [
      ...
      {
        id: "mobile_feature_interest",
        q: "모바일 앱 기능 중 가장 구현해보고 싶은 것은 무엇인가요?",
        a: [
          "로그인과 사용자 관리",
          "푸시 알림",
          "카메라/앨범/파일 업로드",
      ...
      {
        id: "mobile_ui_interest",
        q: "모바일 화면 구현에서 더 자신 있거나 관심 있는 부분은 무엇인가요?",
        a: [
          "깔끔한 앱 화면 디자인",
          "부드러운 화면 전환과 애니메이션",
          "다양한 화면 크기에 맞춘 반응형 UI",
          "사용자 경험을 고려한 앱 흐름 설계"
        ]
      },
      {
        id: "mobile_priority",
        q: "모바일 개발자로 성장하기 위해 가장 필요한 학습은 무엇이라고 느끼나요?",
        a: [
          "프로그래밍 언어 기본기",
          "앱 화면 구성과 상태 관리",
          "서버 API 연동",
    ...
    ai: [
      ...
      {
        id: "ai_math_level",
        q: "수학이나 통계 개념에 대한 현재 자신감은 어느 정도인가요?",
        a: [
          "거의 처음이라 기초부터 필요해요",
          "기본 개념은 알지만 적용은 어려워요",
          "확률/통계/선형대수 개념을 어느 정도 알아요",
          "모델 원리까지 깊게 공부해보고 싶어요"
        ]
      },
      {
        id: "ai_python_level",
        q: "Python 활용 수준은 어느 정도인가요?",
        a: [
          "기초 문법을 배우는 단계",
          "간단한 문제 풀이가 가능한 단계",
          "Pandas/Numpy를 사용해본 단계",
          "모델 학습 코드까지 작성해본 단계"
        ]
      },
      {
        id: "ai_data_interest",
        q: "다루고 싶은 데이터 유형은 무엇인가요?",
        a: [
          "텍스트 데이터",
          "이미지/영상 데이터",
          "숫자/표 형태의 정형 데이터",
      ...
      {
        id: "ai_project_type",
        q: "AI 포트폴리오로 만들고 싶은 프로젝트는 무엇인가요?",
        a: [
          "챗봇/문서 요약 서비스",
          "이미지 분류/객체 인식 서비스",
          "추천 시스템",
      ...
      {
        id: "ai_priority",
        q: "AI 개발자로 성장하기 위해 가장 먼저 보완하고 싶은 부분은 무엇인가요?",
        a: [
          "Python과 데이터 처리 기본기",
          "머신러닝/딥러닝 이론",
          "모델 학습과 평가 경험",
          "AI 모델을 웹/앱 서비스에 연결하는 경험"
        ]
      }
    ],
    ...
    game: [
      ...
      {
        id: "game_engine",
        q: "관심 있거나 사용해보고 싶은 게임 엔진은 무엇인가요?",
        a: [
          "Unity",
          "Unreal Engine",
          "Godot",
      ...
      {
        id: "game_programming_interest",
        q: "게임 프로그래밍에서 가장 흥미로운 부분은 무엇인가요?",
        a: [
          "캐릭터 이동과 조작감",
          "충돌 처리와 물리 시스템",
          "아이템/스킬/전투 시스템",
      ...
      {
        id: "game_priority",
        q: "게임 개발자로 성장하기 위해 가장 필요한 학습은 무엇이라고 느끼나요?",
        a: [
          "프로그래밍 기본기",
          "게임 엔진 사용법",
          "게임 수학과 물리",
    ...
    security: [
      ...
      {
        id: "security_base",
        q: "현재 보안 학습의 기초 수준은 어느 정도인가요?",
        a: [
          "이제 막 관심을 가진 단계",
          "네트워크/운영체제 기초를 배우는 단계",
          "간단한 취약점 실습을 해본 단계",
          "CTF나 모의해킹 경험이 있는 단계"
        ]
      },
      {
        id: "security_web",
        q: "웹 보안에서 가장 공부해보고 싶은 주제는 무엇인가요?",
        a: [
          "SQL Injection",
          "XSS / CSRF",
          "인증/인가 취약점",
      ...
      },
      {
        ...
        q: "보안 전문가로 성장하기 위해 가장 먼저 보완하고 싶은 부분은 무엇인가요?",
        a: [
          "네트워크 기초",
          "운영체제/Linux 기초",
          "웹 구조와 백엔드 이해",
    ...
    devops: [
      {
        id: "devops_area",
        q: "데브옵스/클라우드 분야 중 어떤 방향에 가장 관심이 있나요?",
        a: [
          "서버 배포와 운영",
          "클라우드 인프라 설계",
          "CI/CD 자동화",
      ...
      {
        id: "devops_cloud",
        q: "관심 있거나 사용해보고 싶은 클라우드 플랫폼은 무엇인가요?",
        a: [
          "AWS",
          "Google Cloud",
          "Azure",
      ...
      {
        id: "devops_container",
        q: "컨테이너/배포 기술 중 가장 관심 있는 것은 무엇인가요?",
        a: [
          "Docker",
          "Kubernetes",
          "Nginx",
      ...
      {
        id: "devops_project",
        q: "데브옵스 포트폴리오로 해보고 싶은 프로젝트는 무엇인가요?",
        a: [
          "웹 서비스 클라우드 배포",
          "Docker 기반 배포 환경 구성",
      ...
      {
        id: "devops_priority",
        q: "데브옵스/클라우드 엔지니어로 성장하기 위해 가장 먼저 보완하고 싶은 부분은 무엇인가요?",
        a: [
          "Linux와 서버 기본기",
          "네트워크와 인프라 구조 이해",
          "Docker/배포 자동화",
